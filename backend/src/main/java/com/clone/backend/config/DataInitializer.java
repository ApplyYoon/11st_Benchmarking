        ...
        return args -> {
            ...
            productRepository.saveAll(Arrays.asList(
                    ...
                    Product.builder()
                            ...
                            .category("food").isTimeDeal(true).timeDealEndTime(LocalDateTime.now().plusDays(1))
                            .build(),
                    Product.builder()
                            ...
                            .category("electronics").isTimeDeal(true).timeDealEndTime(LocalDateTime.now().plusDays(1))
                            .build(),
                    // Best Items
                    Product.builder()
